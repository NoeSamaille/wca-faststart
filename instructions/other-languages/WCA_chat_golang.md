...
- you can leverage the [sample code provided](../../instructions/other-languages/sample-code/golang/)
...
[good example](../../instructions/other-languages/sample-code/go/sample.go)

[bad example](../../instructions/other-languages/sample-code/go/bad.go)
