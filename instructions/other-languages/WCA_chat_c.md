...
- you can leverage the [sample code provided](../../instructions/other-languages/sample-code/c/)
...
[good example](../../instructions/other-languages/sample-code/c/sample.c)

[bad example](../../instructions/other-languages/sample-code/c/bad.c)
