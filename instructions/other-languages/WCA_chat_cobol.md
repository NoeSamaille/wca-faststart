...
[COBOL example](../../instructions/other-languages/sample-code/cobol/sample.cbl)

[python source](../../instructions/other-languages/sample-code/cobol/source.py) to be convert to COBOL
